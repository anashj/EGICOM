		...
		<div class="row">
			...
			<div class="col-md-6">
				<section class="section sign-in inner-right-xs">
					<h2 class="bordered">S'authentifier</h2>
					<p>Bonjour, bienvenu dans votre compte</p>

					<div class="social-auth-buttons">
						<div class="row">
							<div class="col-md-6">
								<button class="btn-block btn-lg btn btn-facebook"><i class="fa fa-facebook"></i>S'authentifier par Facebook</button>
							</div>
							<div class="col-md-6">
								<button class="btn-block btn-lg btn btn-twitter"><i class="fa fa-twitter"></i>S'authentifier par Twitter</button>
							</div>
						</div>
					</div>
					...
					<form role="form" class="login-form cf-style-1">
                        ...
                        <div class="field-row clearfix">
                        	<span class="pull-left">
                        		<label class="content-color"><input type="checkbox" class="le-checbox auto-width inline"> <span class="bold">Garder ma session active</span></label>
                        	</span>
                        	<span class="pull-right">
                        		<a href="#" class="content-color bold">Mot de passe oublié?</a>
                        	</span>
                        </div>

                        <div class="buttons-holder">
                            <button type="submit" class="le-button huge">Connexion</button>
                        </div><!-- /.buttons-holder -->
					</form><!-- /.cf-style-1 -->
			...
			<div class="col-md-6">
				<section class="section register inner-left-xs">
					...
					<form role="form" class="register-form cf-style-1">
                        ...
                        <div class="buttons-holder">
                            <button type="submit" class="le-button huge">S'Inscrire</button>
                        </div><!-- /.buttons-holder -->
					</form>

					<h2 class="semi-bold">Inscrivez-vous aujourd'hui et vous serez en mesure de:</h2>

					<ul class="list-unstyled list-benefits">
						<li><i class="fa fa-check primary-color"></i> Accélérez votre chemin à travers le checkout</li>
						<li><i class="fa fa-check primary-color"></i> Suivre facilement vos commandes</li>
						<li><i class="fa fa-check primary-color"></i> Gardez une trace de tous vos achats</li>
					</ul>
