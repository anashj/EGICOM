    ...
    <div class="container">
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="#change-colors">Changer couleurs</a>
        ...
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul class="right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" >
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Turc</a></li>
                ...
                <li><a href="authentication.html">S'authentifier</a></li>
            </ul>
        </div><!-- /.col -->
    </div><!-- /.container -->
</nav><!-- /.top-bar -->
...
<!-- ============================================================= LOGO : END ============================================================= -->		</div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i> (+212) 624 246 707
    </div>
        ...
        <div class="control-group">
            ...
            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">categories</a>
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->		</div><!-- /.top-search-holder -->
    ...
    <div class="wishlist-compare-holder">
        <div class="wishlist ">
            <a href="#"><i class="fa fa-heart"></i>La liste de Souhaits <span class="value">(21)</span> </a>
        </div>
        <div class="compare">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <div class="total-price-basket"> 
                    ...
                    <span class="total-price">
                        <span class="sign">MAD</span><span class="value">3219,00</span>
                    </span>
                </div>
            </a>
...
<!-- ========================================= PRODUCT FILTER : END ========================================= -->
            <div class="widget">
	<h1 class="border">offres speciales </h1>
        ...
        <li>
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 no-margin">
                    ...
                    <div class="price">
                        <div class="price-prev">MAD2000</div>
                        <div class="price-current">MAD1873</div>
                    </div>
                </div>  
            </div>
        </li>
	...
	<div class="simple-banner">
		<a href="#"><img alt="" class="img-responsive" src="ressources/assets/images/blank.gif" data-echo="ressources/assets/images/banner/banner-simple.jpg" /></a>
	</div>
</div>
            <!-- ========================================= FEATURED PRODUCTS ========================================= -->
<div class="widget">
    <h1 class="border">Produits présentés</h1>
    <ul class="product-list">
...
<!-- ========================================= FEATURED PRODUCTS : END ========================================= -->
    ...
    <div class="title-nav">
        <h2 class="inverse">Produits recommendés</h2>
    ...
    <div id="owl-recommended-products" class="owl-carousel product-grid-holder">
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                <div class="ribbon red"><span>Vendu</span></div> 
                <div class="image">
                ...
                <div class="prices">
                    <div class="price-current text-right">MAD1199.00</div>
                </div>
                <div class="hover-area">
                    <div class="add-cart-button">
                        <a href="single-product.html" class="le-button">ajouter dans le panier</a>
                    </div>
                    <div class="wish-compare">
                        <a class="btn-add-to-wishlist" href="#">ajouter à la liste des souhaits</a>
        ...
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                <div class="ribbon green"><span>Meilleurs ventes</span></div> 
                <div class="image">
        ...
        <div class="control-bar">
            <div id="popularity-sort" class="le-select" >
                <select data-placeholder="sort by popularity">
                    <option value="1">1-100 Joueurs</option>
                    <option value="2">101-200 Joueurs</option>
                    <option value="3">200+ Joueurs</option>
                </select>
            </div>
            
            <div id="item-count" class="le-select">
                <select>
                    <option value="1">24 par page</option>
                    <option value="2">48 par page</option>
                    <option value="3">32 par page</option>
                </select>
            </div>
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    <div class="label-discount green">-50% Vendu</div>
                                    <div class="title">
                                ...
                                <div class="prices">
                                    <div class="price-prev">MAD1399.00</div>
                                    <div class="price-current pull-right">MAD1199.00</div>
                                </div>
                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="single-product.html" class="le-button">ajouter dans le panier</a>
                            ...
                            <div class="no-margin col-xs-12 col-sm-5 body-holder">
                                <div class="body">
                                    ...
                                    <div class="addto-compare">
                                        <a class="btn-add-to-compare" href="#">ajouter dans la liste de comparaison</a>
                                    </div>
                                </div>
                            </div><!-- /.body-holder -->
                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                <div class="right-clmn">
                                    <div class="price-current">MAD1199.00</div>
                                    <div class="price-prev">MAD1399.00</div>
                                    <div class="availability"><label>availability:</label><span class="available">  Dans le stock</span></div>
                                    <a class="le-button" href="#">ajouter dans le panier</a>
                                    <a class="btn-add-to-wishlist" href="#">ajouter à la liste des souhaits</a>
                                </div>
                            </div><!-- /.price-area -->
                        </div><!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                <div class="right-clmn">
                                    ...
                                    <a class="le-button disabled" href="#">ajouter dans le panier</a>
                                    <a class="btn-add-to-wishlist" href="#">ajouter à la liste des souhaits</a>
                                </div>
                            </div><!-- /.price-area -->
                        </div><!-- /.row -->
...
<!-- ============================================================= LINKS FOOTER : END ============================================================= -->            </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="index.html">GI5Store</a> - Tout les droits sont reservés
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
