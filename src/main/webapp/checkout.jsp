...
<html lang="en">
	<head>
	    ...
	    <title>GI5-Store check-out</title>
    ...
    <div class="container">
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="#change-colors">Changer de couleurs</a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a href="authentication.html">S'authentifier/S'enregistrer</a></li>
                                            </ul>
                </li>
            </ul>
        </div><!-- /.col -->
        ...
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul class="right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" >
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Englais</a></li>
...
<!-- ============================================================= LOGO : END ============================================================= -->		</div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i> (+212) 24 24 67 07
    </div>
...
<div class="search-area">
    <form>
        <div class="control-group">
            <input class="search-field" placeholder="chercher un item" />

            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">

                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">categoires</a>
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <div class="total-price-basket"> 
                    ...
                    <span class="total-price">
                        <span class="sign">MAD </span><span class="value">32100,00</span>
                    </span>
                </div>
            </a>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-8 no-margin">
                                ...
                                <div class="price">MAD 2700.00</div>
                            </div>
                        </div>
...
<nav id="top-megamenu-nav" class="megamenu-vertical animate-dropdown">
    ...
    <div class="row">
       <div class="col-xs-12 col-sm-4">
        ...
        <div class="col-xs-12 col-sm-4">
            <h2>Ordinateurs Bureau &amp; pc portable</h2>
            <ul>
            ...
            <ul>
                ...
                <li><a href="#">Autre</a></li>
                    ...
                    <li class="dropdown hidden-md">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#">portables &amp; Notebooks</a></li>
                            <li><a href="#">RTV</a></li>
    ...
    <div class="container">
        <div class="col-xs-12 no-margin">
            ...
            <div class="billing-address">
                <h2 class="border h1">adresse de facturation</h2>
                <form>
                    ...
                    <div class="row field-row">
                        <div id="create-account" class="col-xs-12">
                            ...
                            <a class="simple-link bold" href="#">Creer un compte?</a> - Vous allez recevoir un email avec un mot de passe temporaire , veuillez le changer apres votre premiere connexion
                        </div>
                    </div><!-- /.field-row -->
            ...
            <section id="shipping-address">
                <h2 class="border h1">Adresse de livraison</h2>
                <form>
                    <div class="row field-row">
                        <div class="col-xs-12">
                            <input  class="le-checkbox big" type="checkbox"  />
                            <a class="simple-link bold" href="#">Adresse de livraison différente?</a>
                        </div>
                    </div><!-- /.field-row -->
                </form>
            ...
            <section id="your-order">
                <h2 class="border h1">Votre ordre</h2>
                <form>
                    <div class="row no-margin order-item">
                        ...
                        <div class="col-xs-12 col-sm-2 no-margin">
                            <div class="price">MAD20000.00</div>
                        </div>
                    </div><!-- /.order-item -->
                ...
                <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                    <div id="subtotal-holder">
                        <ul class="tabled-data inverse-bold no-border">
                            <li>
                                <label>panier total</label>
                                <div class="value ">MAD8434.00</div>
                            </li>
                            <li>
                                <label>Livraison</label>
                                <div class="value">
                                    <div class="radio-group">
                                        <input class="le-radio" type="radio" name="group1" value="free"> <div class="radio-label bold">livraison gratuite</div><br>
                                        <input class="le-radio" type="radio" name="group1" value="local" checked>  <div class="radio-label">livraison gratuit<br><span class="bold">MAD150</span></div>
                                    </div>
                                </div>
                            </li>
                        </ul><!-- /.tabled-data -->
                        ...
                        <ul id="total-field" class="tabled-data inverse-bold ">
                            <li>
                                <label>Ordre total</label>
                                <div class="value">MAD84340.00</div>
                            </li>
                        </ul><!-- /.tabled-data -->
            ...
            <div id="payment-method-options">
                <form>
                    <div class="payment-method-option">
                        ...
                        <div class="radio-label bold ">Virement bancaire direct<br>
                    ...
                    <div class="payment-method-option">
                        ...
                        <div class="radio-label bold ">paiement par chèque</div>
                    </div><!-- /.payment-method-option -->
                    
                    <div class="payment-method-option">
                        <input class="le-radio" type="radio" name="group2" value="paypal">
                        <div class="radio-label bold ">système paypal</div>
                    </div><!-- /.payment-method-option -->
                </form>
            </div><!-- /#payment-method-options -->
            
            <div class="place-order-button">
                <button class="le-button big">passer la commander</button>
...
<footer id="footer" class="color-bg">
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="index.html">GI5 Store</a> - Tous droits réservés
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
