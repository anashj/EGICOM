        ...
        <div class="breadcrumb-nav-holder minimal">
            <ul>
                ...
                <li class="breadcrumb-item current">
                    <a href="#">Processus de check-out</a>
                </li>
    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-md-3 no-margin sidebar ">
            <div class="widget cart-summary">
                <h1 class="border">Panier</h1>
                <div class="body">
                    <ul class="tabled-data no-border inverse-bold">
                        <li>
                            <label>panier total</label>
                            <div class="value pull-right">MAD84340.00</div>
                        </li>
                        <li>
                            <label>Livraison</label>
                            <div class="value pull-right">livraison gratuite</div>
                        </li>
                    </ul>
            ...
            <div id="cupon-widget" class="widget">
                <h1 class="border">Utilisez le code</h1>
                <div class="body">
                    <form>
                        <div class="inline-input">
                            <input data-placeholder="entrez le code" type="text" />
                            <button class="le-button" type="submit">Valider</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.widget -->
